...
// bool is_bipartite(int v,vector<int>*adj,int i,int pnt,int self,int pself,vector<bool>&visited)
// {
//     for(auto x:adj[i])
//     {
//         if(x!=prnt and visited[i]==true and )
//         return false;
//         else if(!visited[x])
//         {
//           visited[x]=true;  
...
void solve() {
    ...
    //  cin >> v;
     int e=10;
    //  cin >> e;
     vector<pair<int,int>>edge{{1,3},{3,2},{3,4},{2,4},{2,5},{6,7},{7,8},{8,1},{6,4},{9,10},{10,1}};
    //  for(int i=0;i<e;i++)
    //  {
    //      int frm,to;
    //      cin >> frm >> to;
